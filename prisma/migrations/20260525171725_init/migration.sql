...
-- CreateIndex
CREATE INDEX "WalletTransaction_personId_date_idx" ON "WalletTransaction"("personId", "date");

-- CreateIndex
CREATE INDEX "WalletTransaction_userId_date_idx" ON "WalletTransaction"("userId", "date");

-- CreateIndex
CREATE INDEX "WalletTransaction_userId_personId_idx" ON "WalletTransaction"("userId", "personId");
...
-- AddForeignKey
ALTER TABLE "WalletTransaction" ADD CONSTRAINT "WalletTransaction_personId_fkey" FOREIGN KEY ("personId") REFERENCES "Person"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
