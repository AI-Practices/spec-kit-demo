      ...
      {expenses.map((expense) => (
        ...
        >
          ...
          <button
            ...
            className="px-2 py-1 text-xs font-medium text-red-600 hover:text-red-800 hover:bg-red-50 rounded dark:text-red-400 dark:hover:text-red-300 dark:hover:bg-red-900/30"
          >
            Delete
          </button>
        </div>
